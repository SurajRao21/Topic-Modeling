...
from sklearn.decomposition import TruncatedSVD  # LSA is implemented using TruncatedSVD
...
# We're converting the cleaned text into a document-term matrix (DTM) using TF-IDF instead of CountVectorizer.
...
# Step 4: Fit LSA Model
# We now apply Latent Semantic Analysis (LSA) using TruncatedSVD.
# n_components sets the number of topics we want the model to find.
# LSA learns the structure in the text and can decompose the matrix into topics.
n_topics = 2
